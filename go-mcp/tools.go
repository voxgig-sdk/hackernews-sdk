...
type Args struct {
	Entity string         `json:"entity" jsonschema:"item | live_data | story | update | user"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.HackernewsSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "hackernews_list",
		Description: "List records from Hackernews. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "hackernews_load",
		Description: "Load a single record from Hackernews. " +
...
func runOp(client *sdk.HackernewsSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.HackernewsSDK, name string) (sdk.HackernewsEntity, error) {
	switch strings.ToLower(name) {
	case "item":
		return client.Item(nil), nil
	case "live_data":
		return client.LiveData(nil), nil
	case "story":
