// Command Hackernews-mcp is an MCP server exposing the Hackernews
// SDK as MCP tools.
//
// Two tools are registered:
//
//	Hackernews_list  — list records of an entity
//	Hackernews_load  — load a single record of an entity
//
