...
func registerSDKWords(r *eng.Registry, client *sdk.HackernewsSDK) {
...
func runOp(client *sdk.HackernewsSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
