# Hackernews Python SDK



The Python SDK for the Hackernews API — an entity-oriented client following Pythonic conventions.

The SDK exposes the API as capitalised, semantic **Entities** — for example `client.Item()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/hackernews-sdk/releases)) or
...
```
py/
├── hackernews_sdk.py         -- Main SDK module
...
The main module (`hackernews_sdk`) exports the SDK class.
