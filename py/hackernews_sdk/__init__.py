...
from hackernews_sdk.utility import register

# Load features
from hackernews_sdk.feature.base_feature import HackernewsBaseFeature
from hackernews_sdk.features import _has_feature, _make_feature
...
class HackernewsSDK:
    ...
    def get_utility(self):
        return HackernewsUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("HackernewsSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Item(self, data=None) -> "ItemEntity":
        ...
        from hackernews_sdk.entity.item_entity import ItemEntity
    ...
    def LiveData(self, data=None) -> "LiveDataEntity":
        ...
        from hackernews_sdk.entity.live_data_entity import LiveDataEntity
        return LiveDataEntity(self, data)


    def Story(self, data=None) -> "StoryEntity":
        """Entity factory: client.Story().list() / client.Story().load({"id": ...})."""
        from hackernews_sdk.entity.story_entity import StoryEntity
    ...
    def Update(self, data=None) -> "UpdateEntity":
        ...
        from hackernews_sdk.entity.update_entity import UpdateEntity
        return UpdateEntity(self, data)


    def User(self, data=None) -> "UserEntity":
        """Entity factory: client.User().list() / client.User().load({"id": ...})."""
        from hackernews_sdk.entity.user_entity import UserEntity
