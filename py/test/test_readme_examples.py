# Hackernews SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions HackernewsSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both HackernewsSDK(...) and HackernewsSDK.test(...) become
#      HackernewsSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "hackernews_sdk"
_SDK_CLASS = "HackernewsSDK"
