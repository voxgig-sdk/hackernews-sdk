...
local HackernewsSDK = {}
HackernewsSDK.__index = HackernewsSDK
...
HackernewsSDK._make_feature = _make_feature


function HackernewsSDK.new(options)
  local self = setmetatable({}, HackernewsSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function HackernewsSDK:options_map()
...
function HackernewsSDK:get_utility()
  return Utility.copy(self._utility)
end


function HackernewsSDK:get_root_ctx()
  return self._rootctx
end


function HackernewsSDK:prepare(fetchargs)
...
function HackernewsSDK:direct(fetchargs)
...
-- by passing it.
function HackernewsSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function HackernewsSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "HackernewsSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function HackernewsSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = HackernewsSDK.new(sdkopts)
  sdk.mode = "test"
