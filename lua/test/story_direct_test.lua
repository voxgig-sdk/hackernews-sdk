...
describe("StoryDirect", function()
  it("should direct-list-story", function()
    local setup = story_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-story", setup.live and "live" or "unit")
