...
describe("UpdateDirect", function()
  it("should direct-list-update", function()
    local setup = update_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-update", setup.live and "live" or "unit")
