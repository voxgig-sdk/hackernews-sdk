...
describe("LiveDataDirect", function()
  it("should direct-load-live_data", function()
    local setup = live_data_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-live_data", setup.live and "live" or "unit")
...
function live_data_direct_setup(mockres)
