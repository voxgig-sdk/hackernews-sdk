...
local SDK_MODULE = "hackernews_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["item"] = { ["test01"] = { id = "test01" } }, ["live_data"] = { ["test01"] = { id = "test01" } }, ["story"] = { ["test01"] = { id = "test01" } }, ["update"] = { ["test01"] = { id = "test01" } }, ["user"] = { ["test01"] = { id = "test01" } } } }'
