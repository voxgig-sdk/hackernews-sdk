...
const testSeed = `map[string]any{"entity": map[string]any{"item": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "live_data": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "story": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "update": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "user": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
