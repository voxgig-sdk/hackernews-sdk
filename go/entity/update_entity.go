...
func NewUpdateEntity(client *core.HackernewsSDK, entopts map[string]any) *UpdateEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *UpdateEntity) GetName() string { return e.name }
...
func (e *UpdateEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *UpdateEntity) Deleted() bool {
	return e.deleted
}


func (e *UpdateEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewUpdateEntity(e.client, opts)
}

func (e *UpdateEntity) Data(args ...any) any {
...
func (e *UpdateEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Update; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *UpdateEntity) DataTyped(data ...Update) Update {
	if len(data) > 0 {
		return typedFrom[Update](e.Data(asMap(data[0])))
	}
	return typedFrom[Update](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Update (all fields
// optional at the wire level).
func (e *UpdateEntity) MatchTyped(match ...Update) Update {
	if len(match) > 0 {
		return typedFrom[Update](e.Match(asMap(match[0])))
	}
	return typedFrom[Update](e.Match())
}
...
func (e *UpdateEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *UpdateEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *UpdateEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// UpdateListMatch and returns []Update. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *UpdateEntity) ListTyped(reqmatch UpdateListMatch, ctrl map[string]any) ([]Update, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Update](res), nil
}



func (e *UpdateEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *UpdateEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *UpdateEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *UpdateEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
