...
import (
	...
	vs "github.com/voxgig-sdk/hackernews-sdk/go/utility/struct"
)

type LiveDataEntity struct {
	name    string
	client  *core.HackernewsSDK
...
func NewLiveDataEntity(client *core.HackernewsSDK, entopts map[string]any) *LiveDataEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *LiveDataEntity) GetName() string { return e.name }
...
func (e *LiveDataEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *LiveDataEntity) Deleted() bool {
	return e.deleted
}


func (e *LiveDataEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewLiveDataEntity(e.client, opts)
}

func (e *LiveDataEntity) Data(args ...any) any {
...
func (e *LiveDataEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an LiveData; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *LiveDataEntity) DataTyped(data ...LiveData) LiveData {
	if len(data) > 0 {
		return typedFrom[LiveData](e.Data(asMap(data[0])))
	}
	return typedFrom[LiveData](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through LiveData (all fields
// optional at the wire level).
func (e *LiveDataEntity) MatchTyped(match ...LiveData) LiveData {
	if len(match) > 0 {
		return typedFrom[LiveData](e.Match(asMap(match[0])))
	}
	return typedFrom[LiveData](e.Match())
}
...
func (e *LiveDataEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *LiveDataEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// LiveDataLoadMatch and returns an LiveData. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *LiveDataEntity) LoadTyped(reqmatch LiveDataLoadMatch, ctrl map[string]any) (LiveData, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return LiveData{}, err
	}
	return typedFrom[LiveData](res), nil
}



func (e *LiveDataEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *LiveDataEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *LiveDataEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *LiveDataEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *LiveDataEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
