...
func NewStoryEntity(client *core.HackernewsSDK, entopts map[string]any) *StoryEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *StoryEntity) GetName() string { return e.name }
...
func (e *StoryEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *StoryEntity) Deleted() bool {
	return e.deleted
}


func (e *StoryEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewStoryEntity(e.client, opts)
}

func (e *StoryEntity) Data(args ...any) any {
...
func (e *StoryEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Story; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *StoryEntity) DataTyped(data ...Story) Story {
	if len(data) > 0 {
		return typedFrom[Story](e.Data(asMap(data[0])))
	}
	return typedFrom[Story](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Story (all fields
// optional at the wire level).
func (e *StoryEntity) MatchTyped(match ...Story) Story {
	if len(match) > 0 {
		return typedFrom[Story](e.Match(asMap(match[0])))
	}
	return typedFrom[Story](e.Match())
}
...
func (e *StoryEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *StoryEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *StoryEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// StoryListMatch and returns []Story. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *StoryEntity) ListTyped(reqmatch StoryListMatch, ctrl map[string]any) ([]Story, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Story](res), nil
}



func (e *StoryEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *StoryEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *StoryEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *StoryEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
