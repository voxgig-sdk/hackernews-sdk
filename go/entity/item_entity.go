...
func NewItemEntity(client *core.HackernewsSDK, entopts map[string]any) *ItemEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ItemEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ItemEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
