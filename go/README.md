...
The Golang SDK for the Hackernews API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/hackernews-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/hackernews-sdk=../path/to/github.com/voxgig-sdk/hackernews-sdk
```
...
```
github.com/voxgig-sdk/hackernews-sdk/
...
The root package (`github.com/voxgig-sdk/hackernews-sdk`) re-exports everything needed
