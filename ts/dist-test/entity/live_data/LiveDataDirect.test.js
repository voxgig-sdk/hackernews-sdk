...
(0, node_test_1.describe)('LiveDataDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-live_data', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-live_data', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['HACKERNEWS_TEST_LIVE_DATA_ENTID'];
...
//# sourceMappingURL=LiveDataDirect.test.js.map