...
(0, node_test_1.describe)('UpdateDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-update', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-update', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['HACKERNEWS_TEST_UPDATE_ENTID'];
...
//# sourceMappingURL=UpdateDirect.test.js.map