...
(0, node_test_1.describe)('StoryDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-story', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-story', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['HACKERNEWS_TEST_STORY_ENTID'];
...
//# sourceMappingURL=StoryDirect.test.js.map