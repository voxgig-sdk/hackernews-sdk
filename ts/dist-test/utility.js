...
function envOverride(m) {
    if ('TRUE' === process.env.HACKERNEWS_TEST_LIVE ||
        'TRUE' === process.env.HACKERNEWS_TEST_OVERRIDE) {
    ...
    m.HACKERNEWS_TEST_EXPLAIN = process.env.HACKERNEWS_TEST_EXPLAIN || m.HACKERNEWS_TEST_EXPLAIN;
    return m;
}
