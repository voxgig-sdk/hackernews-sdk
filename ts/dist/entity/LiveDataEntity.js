...
exports.LiveDataEntity = void 0;
const HackernewsEntityBase_1 = require("../HackernewsEntityBase");
// TODO: needs Entity superclass
class LiveDataEntity extends HackernewsEntityBase_1.HackernewsEntityBase {
    constructor(client, entopts) {
        super(client, entopts);
        this.name = 'live_data';
        this.name_ = 'live_data';
        this.Name = 'LiveData';
    }
    make() {
        return new LiveDataEntity(this._client, this.entopts());
    }
...
exports.LiveDataEntity = LiveDataEntity;
//# sourceMappingURL=LiveDataEntity.js.map