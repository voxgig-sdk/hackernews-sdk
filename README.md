...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/hackernews` | `npm install @voxgig-sdk/hackernews` |
| Python | `voxgig-sdk-hackernews` | `pip install voxgig-sdk-hackernews` |
| PHP | `voxgig-sdk/hackernews` | `composer require voxgig-sdk/hackernews` |
| Golang | `github.com/voxgig-sdk/hackernews-sdk/go` | `go get github.com/voxgig-sdk/hackernews-sdk/go` |
| Ruby | `voxgig-sdk-hackernews` | `gem install voxgig-sdk-hackernews` |
| Lua | `voxgig-sdk-hackernews` | `luarocks install voxgig-sdk-hackernews` |
