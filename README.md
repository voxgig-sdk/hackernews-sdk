...
Provides public Hacker News data in near real time.

Learn more about HackerNews API at [github.com/HackerNews/API](https://github.com/HackerNews/API).
...
This SDK exposes the API as a small set of **semantic entities** — Item, LiveData, Story, Update and User — that you
...
print_r(array_map(fn($item) => $item->data_get(), $items));
```
