...
The Ruby SDK for the Hackernews API — an entity-oriented client using idiomatic Ruby conventions.
...
raise a `HackernewsError` (a `StandardError` subclass), so wrap
...
```
rb/
├── Hackernews_sdk.rb       -- Main SDK module
