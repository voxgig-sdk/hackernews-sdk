...
class UpdateEntity
  ...
  #
  # @param reqmatch [UpdateListMatch, Hash, nil] match filter (any subset of
  #   Update fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Update>, Array] the matching Update items; raises HackernewsError on failure
