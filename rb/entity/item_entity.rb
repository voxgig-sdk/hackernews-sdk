...
class ItemEntity
  ...
  # @return [Item, Hash] the current Item data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Item fields)
  def match_get
  ...
  #
  # @param reqmatch [ItemListMatch, Hash, nil] match filter (any subset of
  #   Item fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Item>, Array] the matching Item items; raises HackernewsError on failure
