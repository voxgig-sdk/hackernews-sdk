...
class StoryEntity
  ...
  # @return [Story, Hash] the current Story data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Story fields)
  def match_get
  ...
  #
  # @param reqmatch [StoryListMatch, Hash, nil] match filter (any subset of
  #   Story fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Story>, Array] the matching Story items; raises HackernewsError on failure
