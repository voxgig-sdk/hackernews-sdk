...
module HackernewsTestRunner
  ...
  def self.env_override(m)
    live = getenv("HACKERNEWS_TEST_LIVE")
    override = getenv("HACKERNEWS_TEST_OVERRIDE")
    ...
    explain = getenv("HACKERNEWS_TEST_EXPLAIN")
    m["HACKERNEWS_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = HackernewsTestRunner
Helpers = HackernewsHelpers
Vs = VoxgigStruct
