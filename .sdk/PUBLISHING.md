...
|---|---|---|
| `ts/` | @voxgig-sdk/hackernews-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/hackernews-sdk \
      --repository voxgig-sdk/hackernews-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/hackernews-sdk` shows it, and
`npm trust revoke @voxgig-sdk/hackernews-sdk --id=<id>` removes it.
