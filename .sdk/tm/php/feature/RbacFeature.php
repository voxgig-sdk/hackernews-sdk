...
class HackernewsRbacFeature extends HackernewsBaseFeature
{
    ...
    private function _required(HackernewsContext $ctx): ?string
    {
    ...
    private function _reject(HackernewsContext $ctx, string $required): void
    {
    ...
    private function _track(HackernewsContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
