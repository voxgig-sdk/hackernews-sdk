...
// Hackernews SDK ratelimit feature
...
class HackernewsRatelimitFeature extends HackernewsBaseFeature
{
    ...
    private function _acquire(HackernewsContext $ctx): void
    {
    ...
    private function _track(HackernewsContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
