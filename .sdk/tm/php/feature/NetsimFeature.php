...
class HackernewsNetsimFeature extends HackernewsBaseFeature
{
    ...
    private function _simulate(HackernewsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(HackernewsContext $ctx, array $applied): void
    {
        $client = $this->client;
