...
// Hackernews SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = HackernewsOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(HackernewsOmni::structfix($now, Struct::undef()))
                        !== json_encode(HackernewsOmni::structfix($val, Struct::undef()))) {
