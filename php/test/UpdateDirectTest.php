...
class UpdateDirectTest extends TestCase
{
    public function test_direct_list_update(): void
    {
        $setup = update_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-update", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
...
function update_direct_setup($mockres)
{
