...
class HackernewsTestRunner
{
    ...
    {
        $live = self::getenv('HACKERNEWS_TEST_LIVE');
        $override = self::getenv('HACKERNEWS_TEST_OVERRIDE');
        ...
        $explain = self::getenv('HACKERNEWS_TEST_EXPLAIN');
...
class_alias('HackernewsTestRunner', 'Runner');
class_alias('HackernewsHelpers', 'Helpers');
