...
// Hackernews SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (HackernewsSDK::test)
...
{
    private const SDK_CLASS = 'HackernewsSDK';
    ...
    private const SDK_BASE = 'hackernews_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../hackernews_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
