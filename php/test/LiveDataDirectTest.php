...
class LiveDataDirectTest extends TestCase
{
    public function test_direct_load_live_data(): void
    {
        $setup = live_data_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-live_data", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
