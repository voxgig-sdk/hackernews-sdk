...
class UpdateEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set HACKERNEWS_TEST_UPDATE_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
        ...
        $update_ref01_data = null;
        if (count($update_ref01_data_raw) > 0) {
...
function update_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("HACKERNEWS_TEST_UPDATE_ENTID");
