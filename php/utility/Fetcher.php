...
// Hackernews SDK utility: fetcher
...
class HackernewsFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; HackernewsSDK/1.0)';
    ...
    public static function call(HackernewsContext $ctx, string $fullurl, array $fetchdef): array
    {
