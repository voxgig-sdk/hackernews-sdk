...
// Hackernews SDK utility: graphql
//
...
class HackernewsGraphql
{
    ...
    // equivalent.
    public static function body(HackernewsContext $ctx): mixed
    {
    ...
    public static function errors(HackernewsContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
