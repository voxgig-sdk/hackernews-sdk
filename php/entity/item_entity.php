...
class ItemEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ItemEntity($this->_client, $opts);
    }

    /**
     * @param Item|array $args Item data (assoc-array) to store.
     */
    ...
    /**
     * @return Item|array The current Item data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Item fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Item fields).
     */
    ...
    /**
     * List Item items matching the given filter.
     *
     * @param ItemListMatch|array|null $reqmatch Match filter (any subset
     *   of Item fields) as an assoc-array; ItemListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Item[]|array A list of Item items as assoc-arrays at
