...
The PHP SDK for the Hackernews API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->Item(null)->list(null, null);
...
[$result, $err] = $client->Hackernews(null)->load(
    ["id" => "test01"], null
);
