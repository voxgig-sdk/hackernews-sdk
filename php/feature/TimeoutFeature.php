...
// Hackernews SDK timeout feature
...
class HackernewsTimeoutFeature extends HackernewsBaseFeature
{
    ...
    private function _with_timeout(HackernewsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(HackernewsContext $_ctx, float $ms): void
    {
        $client = $this->client;
