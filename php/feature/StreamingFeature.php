...
// Hackernews SDK streaming feature
...
class HackernewsStreamingFeature extends HackernewsBaseFeature
{
    ...
    private function _iterate(HackernewsResult $result): \Generator
    {
    ...
    private function _streamable(HackernewsContext $ctx): bool
    {
