...
// Hackernews SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class HackernewsTestFeature extends HackernewsBaseFeature
{
    ...
    public function init(HackernewsContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (HackernewsContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = HackernewsParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (HackernewsContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(HackernewsContext $ctx, $op, $args): array
    {
