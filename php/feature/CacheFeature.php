...
class HackernewsCacheFeature extends HackernewsBaseFeature
{
    ...
    private function _through(HackernewsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
