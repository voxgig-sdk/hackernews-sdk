...
class HackernewsProxyFeature extends HackernewsBaseFeature
{
    ...
    public function init(HackernewsContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (HackernewsContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
