...
// Hackernews SDK clienttrack feature
...
class HackernewsClienttrackFeature extends HackernewsBaseFeature
{
    ...
    public function PostConstruct(HackernewsContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Hackernews-SDK';
